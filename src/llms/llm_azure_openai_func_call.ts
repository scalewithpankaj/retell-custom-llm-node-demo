...
const agentPrompt =
  ...
  "4. Name — 'Perfect, I've got that time open. Could I grab your name, please?'\n" +
      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            action: {type: "string", description: "Must always be hardcoded/passed as 'book_appointment'.",
